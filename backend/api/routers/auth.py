...
from api.serializers.userSerializers import userResponseEntity, userEntity
...
async def create_user(payload: users.CreateUserSchema):
...
@router.post("/login")
def login(
    payload: users.LoginUserSchema, response: Response, Authorize: AuthJWT = Depends()
):
